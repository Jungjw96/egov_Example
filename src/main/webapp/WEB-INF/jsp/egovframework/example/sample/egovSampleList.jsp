...
<head>
    ...
    <script type="text/javaScript" language="javascript" defer="defer">
        ...
        function fn_test(){
         	document.listForm.action = "<c:url value='/jwTest.do'/>";
           	document.listForm.submit();
        }
        
        function fn_prac(){
        	document.listForm.action = "<c:url value='userSelect.do'/>";
        	document.listForm.submit();
        }
    </script>
</head>
        ...
        <div id="content_pop">
        	...
        	<div id="sysbtn">
        	  <ul>
                  ...
                  <li>
        	          <span class="btn_blue_l">
        	              <a href="javascript:fn_test();">지우TEST</a>
                          <img src="<c:url value='/images/egovframework/example/btn_bg_r.gif'/>" style="margin-left:6px;" alt=""/>
                      </span>
                  </li>
                  ...
                  <li>
        	          <span class="btn_blue_l">
        	              <a href="javascript:fn_prac();">지우연습</a>
                          <img src="<c:url value='/images/egovframework/example/btn_bg_r.gif'/>" style="margin-left:6px;" alt=""/>
                      </span>
                  </li>
                <%--   
                  <li>
        	          <span class="btn_blue_l">
        	              <a href="javascript:fn_prac();">ㅇㅇㅇㅇ</a>
                          <img src="<c:url value='/images/egovframework/example/btn_bg_r.gif'/>" style="margin-left:6px;" alt=""/>
                      </span>
                  </li>
                   --%>
